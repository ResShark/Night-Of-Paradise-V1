...
local cityid = "2988507" -- Paris
local apikey = "195a27393ed2360d5efd0eb11161b8b4"
...
function sendToDiscordMeteo (type, name,message,color)
    local DiscordWebHook = "https://discordapp.com/api/webhooks/682049496133533707/fZPUZxGZv9I_BimHdmERIrurte0_mQEkbIcddS5GrfjTtcp3-QMLmRkBqX6lMqKMVwJz"
