...
exports.realtime:SetClientRender(true/false)
exports.realtime:IsClientRendering()
-- IsClientRendering will return true if the client render the time but if the server render the time will return false