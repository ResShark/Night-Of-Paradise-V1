...
function OpenPhoneMenu()
	...
	local elements = {
	  {label = 'Actualiser', value = 'sim_actualise'},
	...
	ESX.UI.Menu.Open(
	  ...
	  function(data, menu)
		...
		if data.current.value == 'sim_actualise' then
			ESX.UI.Menu.CloseAll()
			ESX.ShowNotification("Vous avez actualiser votre téléphone ~o~")
				TriggerServerEvent('gcPhone:allUpdate')
...
RegisterNetEvent ('NB:openMenuPhone')
 AddEventHandler ('NB:openMenuPhone' , function ()
    OpenPhoneMenu()
 end)