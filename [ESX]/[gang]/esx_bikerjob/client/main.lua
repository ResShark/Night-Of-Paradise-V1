  ...
  ESX.UI.Menu.CloseAll()
    ...
    ESX.UI.Menu.Open(
      ...
      if data.current.value == 'biker_wear' then
        ...
        if skin.sex == 0 then
					local clothesSkin = {
            		['tshirt_1'] = 136, ['tshirt_2'] = 12,
					['ears_1']   = -1, 	['ears_2']   = 0,
            		['torso_1']  = 175, ['torso_2']  = 0,
            		['arms']     = 2,
            		['pants_1']  = 76, 	['pants_2']  = 7,
            		['shoes_1']  = 24,  ['shoes_2']  = 0,
            		['helmet_1'] = 14,  ['helmet_2'] = 1
					}
...
AddEventHandler('esx_bikerjob:hasEnteredEntityZone', function(entity)
  ...
  if (PlayerData.job ~= nil and PlayerData.job.name == 'biker') or (PlayerData.job2 ~= nil and PlayerData.job2.name == 'biker') or (PlayerData.job3 ~= nil and PlayerData.job3.name == 'biker') and not IsPedInAnyVehicle(playerPed, false) then
...
Citizen.CreateThread(function()
  while true do
    ...
    if (PlayerData.job ~= nil and PlayerData.job.name == 'biker') or (PlayerData.job2 ~= nil and PlayerData.job2.name == 'biker') or (PlayerData.job3 ~= nil and PlayerData.job3.name == 'biker') then
      ...
      for k,v in pairs(Config.BikerStations) do
		...
		if Config.EnablePlayerManagement and PlayerData.job3 ~= nil and PlayerData.job3.name == 'biker' and PlayerData.job3.grade_name == 'boss' then
...
Citizen.CreateThread(function()
  while true do
   ...
   if IsControlPressed(0,  Keys['F7']) and PlayerData.job2 ~= nil and PlayerData.job2.name == 'biker' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'biker_actions') and (GetGameTimer() - GUI.Time) > 150 then
     OpenBikerActionsMenu()
     GUI.Time = GetGameTimer()
    end
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.job3 ~= nil and PlayerData.job3.name == 'biker' and (GetGameTimer() - GUI.Time) > 150 then
   ...
   if IsControlPressed(0,  Keys['F9']) and PlayerData.job3 ~= nil and PlayerData.job3.name == 'biker' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'biker_actions') and (GetGameTimer() - GUI.Time) > 150 then
     OpenBikerActionsMenu()
     GUI.Time = GetGameTimer()
    end
