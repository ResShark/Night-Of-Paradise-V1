        ...
        if not DoesEntityExist(vehicle) then
          ...
          if Config.MaxInService == -1 then
            ...
            ESX.Game.SpawnVehicle(model, {
			  ...
			  SetVehicleCustomPrimaryColour(vehicle, 129, 75, 1)
            end)
...
AddEventHandler('esx_carteljob:hasEnteredEntityZone', function(entity)
  ...
  if (PlayerData.job ~= nil and PlayerData.job.name == 'cartel') or (PlayerData.job2 ~= nil and PlayerData.job2.name == 'cartel') or (PlayerData.job3 ~= nil and PlayerData.job3.name == 'cartel') and not IsPedInAnyVehicle(playerPed, false) then
...
Citizen.CreateThread(function()
  while true do
    ...
    if (PlayerData.job ~= nil and PlayerData.job.name == 'cartel') or (PlayerData.job2 ~= nil and PlayerData.job2.name == 'cartel') or (PlayerData.job3 ~= nil and PlayerData.job3.name == 'cartel') then
      ...
      for k,v in pairs(Config.CartelStations) do
		...
		if Config.EnablePlayerManagement and PlayerData.job3 ~= nil and PlayerData.job3.name == 'cartel' and PlayerData.job3.grade_name == 'boss' then
...
Citizen.CreateThread(function()
  while true do
   ...
   if IsControlPressed(0,  Keys['F7']) and PlayerData.job2 ~= nil and PlayerData.job2.name == 'cartel' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'cartel_actions') and (GetGameTimer() - GUI.Time) > 150 then
     OpenCartelActionsMenu()
     GUI.Time = GetGameTimer()
    end
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.job3 ~= nil and PlayerData.job3.name == 'cartel' and (GetGameTimer() - GUI.Time) > 150 then
   ...
   if IsControlPressed(0,  Keys['F9']) and PlayerData.job3 ~= nil and PlayerData.job3.name == 'cartel' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'cartel_actions') and (GetGameTimer() - GUI.Time) > 150 then
     OpenCartelActionsMenu()
     GUI.Time = GetGameTimer()
    end
