...
Citizen.CreateThread(function()
  while true do
   ...
   if IsControlPressed(0,  Keys['F9']) and PlayerData.job3 ~= nil and PlayerData.job3.name == 'mafia' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'mafia_actions') and (GetGameTimer() - GUI.Time) > 150 then
     OpenMafiaActionsMenu()
     GUI.Time = GetGameTimer()
    end
