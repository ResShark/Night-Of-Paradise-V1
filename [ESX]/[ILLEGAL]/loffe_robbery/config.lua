...
Config.Shops = {
    ...
    {coords = vector3(24.03, -1345.63, 29.5-0.98), heading = 266.0, money = {10000, 20000}, cops = 2, blip = true, name = 'Braquage Superette', cooldown = {hour = 0, minute = 30, second = 0}, robbed = false},
    {coords = vector3(-705.73, -914.91, 19.22-0.98), heading = 91.0, money = {10000, 20000}, cops = 2, blip = true, name = 'Braquage Superette', cooldown = {hour = 0, minute = 30, second = 0}, robbed = false},
    {coords = vector3(-1486.67, -377.65, 40.10-0.98), heading = 135.0, money = {10000, 20000}, cops = 2, blip = true, name = 'Braquage Superette', cooldown = {hour = 0, minute = 30, second = 0}, robbed = false},
    {coords = vector3(1134.23, -983.11, 46.47-0.98), heading = 280.0, money = {10000, 20000}, cops = 2, blip = true, name = 'Braquage Superette', cooldown = {hour = 0, minute = 30, second = 0}, robbed = false},
    {coords = vector3(549.14, 2670.72, 42.15-0.98), heading = 93.0, money = {10000, 20000}, cops = 2, blip = true, name = 'Braquage Superette', cooldown = {hour = 0, minute = 30, second = 0}, robbed = false},
    {coords = vector3(2557.47, 380.74, 108.62-0.98), heading = 359.0, money = {10000, 20000}, cops = 2, blip = true, name = 'Braquage Superette', cooldown = {hour = 0, minute = 30, second = 0}, robbed = false}
