...
RegisterNetEvent('esx_ammujob:annonce')
AddEventHandler('esx_ammujob:annonce', function(text)
    texteafiche = text
    affichenews = true
...
RegisterNetEvent('esx_ammujob:annoncestop')
AddEventHandler('esx_ammujob:annoncestop', function()
    affichenews = false
    ...
    while messagenotfinish do
      ...
      DisplayOnscreenKeyboard(1, "FMMC_MPM_NA", "", "", "", "", "", 30)
        ...
        if (GetOnscreenKeyboardResult()) then
           ...
           TriggerServerEvent('esx_ammujob:annonce',result)
