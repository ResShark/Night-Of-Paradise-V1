...
RegisterServerEvent('esx_ammujob:annonce')
AddEventHandler('esx_ammujob:annonce', function(result)
  ...
  for i=1, #xPlayers, 1 do
    ...
    TriggerClientEvent('esx_ammujob:annonce', xPlayers[i],text)
  end
  ...
  for i=1, #xPlayers, 1 do
    local xPlayer = ESX.GetPlayerFromId(xPlayers[i])
    TriggerClientEvent('esx_ammujob:annoncestop', xPlayers[i])
  end
end)
