...
Config.NPCSpawnDistance           = 3000.0
Config.NPCNextToDistance          = 50.0
Config.NPCJobEarnings             = { min = 200, max = 700 }
Config.Locale = 'fr'
...
Config.Zones = {
	...
	MecanoActions = {
		Pos   = { x = 1002.23, y = -2315.68, z = 34.32 },
	...
	Craft = {
		Pos   = { x = 1011.96, y = -2316.61, z = 29.51 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = 25,
	},
	...
	VehicleSpawnPoint = {
		Pos   = { x = 1003.99, y = -2327.76, z = 29.50 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = -1,
	},

	VehicleDeleter = {
		Pos   = { x = 992.15, y = -2312.22, z = 29.70 },
	...
	VehicleDelivery = {
		Pos   = { x = 990.95, y = -2350.55, z = 29.70 },
