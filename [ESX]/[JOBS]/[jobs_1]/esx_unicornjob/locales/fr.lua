Locales['fr'] = {
    ...
    ['press_collect'] = 'Appuie sur ~INPUT_CONTEXT~ pour récupérer des boissons',
    ['press_traitement'] = 'Appuie sur ~INPUT_CONTEXT~ pour mettre les boissons en caisse',
    ['press_sell'] = 'Appuie sur ~INPUT_CONTEXT~ pour livrer les caisse',
    ['no_product_sale'] = 'Vous n\'avez plus de produit a vendre',
    ['transforming_in_progress'] = 'Mise en caisse en cours',
