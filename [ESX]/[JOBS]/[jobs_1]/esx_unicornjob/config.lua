...
Config.Zones = {
    ...
    Vehicles = {
        Pos          = { x = 317.56, y = -685.42, z = 28.48 },
        SpawnPoint   = { x = 327.75, y = -679.76, z = 28.31 },
