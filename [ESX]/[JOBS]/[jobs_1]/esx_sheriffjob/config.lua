...
Config.PoliceStations = {
	...
	LSPD = {
		...
		Cloakrooms = {
			vector3(-440.30, 5991.19, 31.71)
		},

		Armories = {
			vector3(-437.77, 5988.39, 31.71)
		},
...
Config.AuthorizedWeapons = {
	...
	intendent = {
		...
		{ weapon = 'WEAPON_STUNGUN', price = 500 },
		{ weapon = 'WEAPON_FLASHLIGHT', price = 100 },
		{ weapon = 'weapon_pumpshotgun', price = 2000 }
	},
	...
	lieutenant = {
		...
		{ weapon = 'WEAPON_STUNGUN', price = 500 },
		{ weapon = 'WEAPON_FLASHLIGHT', price = 100 },
		{ weapon = 'weapon_carbinerifle', price = 3000 },
		{ weapon = 'weapon_pumpshotgun', price = 2000 }
	},
	...
	boss = {
		{ weapon = 'WEAPON_REVOLVER', price = 100 },
		{ weapon = 'WEAPON_NIGHTSTICK', price = 100 },
		{ weapon = 'WEAPON_STUNGUN', price = 500 },
		{ weapon = 'WEAPON_FLASHLIGHT', price = 100 },
		{ weapon = 'weapon_carbinerifle', price = 3000 },
...
Config.AuthorizedVehicles = {
	...
	lieutenant = {
		...
		{ model = 'bcso4', label = 'Sheriff 4x4', price = 1 },
		{ model = 'pbus', label = 'Bus Pénitenciaire', price = 1 }
	},
	...
	boss = {
		{ model = 'bcso1', label = 'Sheriff Cruiser 2', price = 1 },
		{ model = 'bcso2', label = 'Sheriff Dodge 2', price = 1 },
		{ model = 'bcso3', label = 'Sheriff Dodge', price = 1 },
		{ model = 'riot', label = 'Sheriff RIOT', price = 1 },
