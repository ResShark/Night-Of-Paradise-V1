Citizen.CreateThread(function()
	while true do
		SetDiscordAppId(655541130712317955)
		SetDiscordRichPresenceAsset('night')
        SetDiscordRichPresenceAssetText('Paradise RP, Rejoingnez-nous !.')
        SetDiscordRichPresenceAssetSmall('night')
        SetDiscordRichPresenceAssetSmallText('https://discord.gg/RmCxDtt')
		  players = {}
  			for i = 0, 255 do
