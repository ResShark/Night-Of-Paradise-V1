...
RegisterServerEvent('NB:promouvoirplayerorg')
AddEventHandler('NB:promouvoirplayerorg', function(target)
...
RegisterServerEvent('NB:destituerplayerorg')
AddEventHandler('NB:destituerplayerorg', function(target)
	...
	if(targetXPlayer.job3.grade == 0)then
		...
		if(sourceXPlayer.job3.name == targetXPlayer.job.name)then

			local grade = tonumber(targetXPlayer.job3.grade) - 1 
			local job3 = targetXPlayer.job3.name

			targetXPlayer.setJob3(job3, grade)
...
RegisterServerEvent('NB:recruterplayerorg')
AddEventHandler('NB:recruterplayerorg', function(target, job3, grade)
...
RegisterServerEvent('NB:virerplayerorg')
AddEventHandler('NB:virerplayerorg', function(target)

	local _source = source

	local sourceXPlayer = ESX.GetPlayerFromId(_source)
	local targetXPlayer = ESX.GetPlayerFromId(target)
	local job3 = "unemployed3"
	local grade = "0"
