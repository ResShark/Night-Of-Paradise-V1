...
m.messages = {  
	"^8Toute demande de give au fonda/admin sera puni d'un ban 48h ! ",
	"^8Besoin d'aide faite /help ", 
    '^8DISCORD OBLIGATOIRE ! https://discord.gg/mn472dA ',
    '^8NOM PRENOM RP STEAM OBLIGATOIRE',
