...
Config.Zones = {
    ...
    GunShop = {
        legal = 0,
        Items = {
			{name  = "WEAPON_FLASHLIGHT", price = 25000, label = "Lampe Torche"},
			{name  = "WEAPON_HAMMER", price = 30000, label = "Marteau"},
			{name  = "WEAPON_CROWBAR", price = 40000, label = "Pied de biche"},
			{name  = "WEAPON_HATCHET", price = 40000, label = "Hache"},
            {name  = "WEAPON_BAT", price = 45000, label = "Batte de Baseball"},
			{name  = "WEAPON_KNUCKLE", price = 50000, label = "Poing Americain"},
			{name  = "WEAPON_KNIFE", price = 50000, label = "Couteau"},
			{name  = "WEAPON_SWITCHBLADE", price = 50000, label = "Couteau à Cran d'Arrêt"},
			{name  = "WEAPON_GOLFCLUB", price = 45000, label = "Club de Gold"},
			{name  = "WEAPON_MACHETE", price = 70000, label = "Machette"},
        },
        Items1 = {
