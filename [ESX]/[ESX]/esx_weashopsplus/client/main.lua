...
RegisterNetEvent('esx_weashop:checkLicense')
AddEventHandler('esx_weashop:checkLicense', function(license)
  for i = 1, #licenses, 1 do
   Licenses[licenses[i].type] = true
  end         
end)
...
function OpenMainMenu(zone)
  ...
  ESX.UI.Menu.Open(
    'default', GetCurrentResourceName(), 'wea_cat',
    {
	  ...
	  align    = 'left',
      elements = {
        { label = "Armes Blanches", value = 'wl_1' },
        { label = "PPA", value = 'wl_2' },
        --{ label = "Mercenaire", value = 'wl_3' },
      }
    },
    function (data, menu)
